...
if __name__ == "__main__":
    ...
    def create_simulation(p):
        ...
        sim += mlxtk.tasks.CreateOperator(
            "hamiltonian_1b.opr", system.get_hamiltonian_1b()
        )
        sim += mlxtk.tasks.CreateMBOperator(
            "hamiltonian.mb_opr", system.get_hamiltonian()
        )
        sim += mlxtk.tasks.CreateMBOperator(
        ...
        sim += mlxtk.tasks.CreateMBOperator(
            "com_2.mb_opr", system.get_com_operator_squared()
        )
        sim += mlxtk.tasks.MCTDHBCreateWaveFunction(
            "initial.wfn", "hamiltonian_1b.opr", p.N, p.m
        )
