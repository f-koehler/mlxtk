...
class NumberStateAnalysis(Task):
    def __init__(
        self,
        ...
        **kwargs,
        ...
        self.logger = get_logger(__name__ + ".NumberStateAnalysis")
    ...
    def task_compute(self) -> Dict[str, Any]:
        ...
        return {
            "name": f"number_state_analysis:{self.name}:compute",
            "actions": [action_compute],
            "targets": [str(self.result)],
            "file_dep": [str(self.wave_function), str(self.basis), str(self.psi)],
        }
